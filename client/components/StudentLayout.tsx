...
export default function StudentLayout() {
  ...
  const navItems = [
    ...
    { label: "View Menu", path: "/student/menu" },
    { label: "Meal Attendance", path: "/student/attendance" },
    { label: "Meal Cancellation", path: "/student/cancellation" },
    { label: "View Bill", path: "/student/bill" },
